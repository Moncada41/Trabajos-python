...
list = ["malicioso" , "placaje" , "ascuas" ] 

while PS_jugador > 0: #no se como escribir el while
    ataque_jugador = input("Ataque: ")
    while not ataque_jugador: ""
    if ataque_jugador == list[0]:
        PS_oponente -= 10
        ataque_jugador = ""
    elif ataque_jugador == list[1]:
        PS_oponente -= 10
        ataque_jugador = ""
    elif ataque_jugador == list[2]:
        PS_oponente -= 10
        ataque_jugador = ""
    ...
    if ataque_oponente == 1:
        ...
        PS_jugador -= 10
        print("El oponente usó xx")
    elif ataque_oponente == 3:
        PS_jugador -= 10
        print("El oponente usó yy")
